...
/**
 * This interface is used as a cache object for export.
 * ALL OBJECTS SHOULD BE RESET AS SOON AS POSSIBLE.
 * TODO use Hilt scope instead.
 */
interface ExportCacheDataSource {
    /**
     * Key used to encrypt data file in final archive.
     */
