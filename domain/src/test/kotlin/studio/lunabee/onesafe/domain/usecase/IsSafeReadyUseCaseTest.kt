...
// TODO <multisafe> update tests

class IsSafeReadyUseCaseTest {
    private val mainCryptoRepository: MainCryptoRepository = mockk()
    private val useCase: IsSafeReadyUseCase = IsSafeReadyUseCase(mainCryptoRepository, DummySafeRepository())
