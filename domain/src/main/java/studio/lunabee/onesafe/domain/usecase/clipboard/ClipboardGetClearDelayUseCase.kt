 ...
 */
class ClipboardGetClearDelayUseCase @Inject constructor(
    private val securityOptionRepository: SecurityOptionRepository,
) {
    operator fun invoke(): Duration = securityOptionRepository.clipboardDelay
    fun getAsFlow(): Flow<Duration> = securityOptionRepository.clipboardDelayFlow
}
