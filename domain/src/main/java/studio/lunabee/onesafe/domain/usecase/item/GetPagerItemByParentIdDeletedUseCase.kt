 ...
 * Last modified 12/14/23, 3:48 PM
 */
...
class GetPagerItemByParentIdDeletedUseCase @Inject constructor(
    ...
    operator fun invoke(pagingConfig: PagingConfig, parentId: UUID?): Flow<PagingData<SafeItem>> {
