...
class BinPagedPlainItemDataUseCase @Inject constructor(
    ...
    override fun itemFlow(pagingConfig: PagingConfig): Flow<PagingData<SafeItem>> =
        getPagerItemByParentsUseCase.invoke(pagingConfig, null, true)

    override fun itemWithIdentifierFlow(pagingConfig: PagingConfig): Flow<PagingData<SafeItemWithIdentifier>> =
        getPagerItemByParentsUseCase.withIdentifier(pagingConfig, null, true)
}
