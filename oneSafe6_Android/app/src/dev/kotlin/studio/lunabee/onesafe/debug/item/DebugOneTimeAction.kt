...
fun DebugOneTimeAction(
    ...
    Button(
        ...
        DropdownMenu(
            ...
            OSDropdownMenuItem(text = LbcTextSpec.Raw("Show enable safe CTA"), null) {
                data.resetSafeCta()
                isExpanded = false
                data.closeDrawer()
            }
            OSDropdownMenuItem(text = LbcTextSpec.Raw("Show discover bubbles CTA"), null) {
                data.resetBubblesCta()
                isExpanded = false
                data.closeDrawer()
            }
            ...
            OSDropdownMenuItem(text = LbcTextSpec.Raw("Reset last export date"), null) {
                data.resetLastExportDate()
                isExpanded = false
                data.closeDrawer()
            }
        }
