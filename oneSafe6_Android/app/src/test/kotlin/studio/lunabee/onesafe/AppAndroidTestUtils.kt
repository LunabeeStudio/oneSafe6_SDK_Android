...
// TODO <robolectric> share with AndroidTest
...
internal suspend fun CreateContactUseCase.test(
    ...
    sharingMode: MessageSharingMode = MessageSharingMode.CypherText,
): DoubleRatchetUUID {
    invoke(PlainContact(id, name, sharedKey, sharedConversationId, sharingMode))
    return id
}
