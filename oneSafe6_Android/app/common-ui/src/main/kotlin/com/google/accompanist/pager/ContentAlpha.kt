...
// Extracted from M2 to keep alpha on disabled element
// cf Note: For disabled states in M3, it’s still acceptable to use “on” colors with alpha values, like in M2.
...
object ContentAlpha {
     ...
     */
    @Composable
    @Suppress("MemberNameEqualsClassName") // keep M2 naming
    private fun contentAlpha(
        ...
        val isDark = LocalDesignSystem.current.isSystemInDarkTheme
        return if (isDark) {
