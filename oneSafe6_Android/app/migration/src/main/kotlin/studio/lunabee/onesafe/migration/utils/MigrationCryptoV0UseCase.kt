...
/**
 * Use case to call crypto functions as of V0 (i.e with associated data). Catch and rethrow crypto exception for finner
...
class MigrationCryptoV0UseCase @Inject constructor(
    ...
    fun getDecryptStream(aFile: AtomicFile, plainKey: ByteArray, username: ByteArray): InputStream {
        val cryptoStream = try {
            cryptoEngine.getDecryptStream(aFile, plainKey, username)
        } catch (e: GeneralSecurityException) {
