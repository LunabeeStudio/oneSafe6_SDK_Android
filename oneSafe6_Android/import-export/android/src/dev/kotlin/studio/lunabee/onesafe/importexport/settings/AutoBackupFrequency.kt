...
// ⚠️ DEV implementation -> see prod/studio/lunabee/onesafe/importexport/settings/AutoBackupFrequency.kt
enum class AutoBackupFrequency(val repeat: Duration, val flex: Duration, val text: LbcTextSpec) {
    ASAP(
        repeat = PeriodicWorkRequest.MIN_PERIODIC_INTERVAL_MILLIS.milliseconds,
