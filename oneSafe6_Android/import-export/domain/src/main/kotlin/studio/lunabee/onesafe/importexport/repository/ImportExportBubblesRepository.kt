 ...
 * Last modified 21/08/2024 13:18
 */
...
interface ImportExportBubblesRepository {
    suspend fun save(
    ...
    suspend fun getAllByContactList(contactIds: List<DoubleRatchetUUID>): List<SafeMessage>
}
