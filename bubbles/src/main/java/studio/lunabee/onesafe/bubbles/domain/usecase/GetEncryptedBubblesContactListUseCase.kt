...
class GetEncryptedBubblesContactListUseCase @Inject constructor(
    private val bubblesContactRepository: BubblesContactRepository,
) {
    operator fun invoke(): Flow<List<EncBubblesContactInfo>> = bubblesContactRepository.getAllContactsFlow()
}
