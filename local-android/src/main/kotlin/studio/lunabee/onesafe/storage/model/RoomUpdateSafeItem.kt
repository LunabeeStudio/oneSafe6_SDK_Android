 ...
 *
 * Created by Lunabee Studio / Date - 12/15/2023 - for the oneSafe6 SDK.
 * Last modified 12/15/23, 11:39 AM
 */
...
class RoomUpdateSafeItem(
    ...
    @ColumnInfo(name = "deleted_parent_id") val deletedParentId: UUID?,
