 ...
 * Last modified 6/26/23, 8:10 AM
 */

package studio.lunabee.onesafe.messaging.domain.model

/**
 * Message added to a queue for future processing
 *
 * @param id auto generated id
 * @param encIncomingMessage raw message
 * @param encChannel encrypted channel name
 */
class EnqueuedMessage(
    val id: Int,
    val encIncomingMessage: ByteArray,
