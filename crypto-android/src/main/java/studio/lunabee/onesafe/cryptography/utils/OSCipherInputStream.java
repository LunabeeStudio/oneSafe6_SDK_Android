...
/**
 * Copy of the [CipherInputStream] from [javax.crypto] but with bigger buffer
 * Buffer of 8 MB
 */
public class OSCipherInputStream extends FilterInputStream {
    ...
    private byte[] ibuffer = new byte[BUFFER_SIZE];
