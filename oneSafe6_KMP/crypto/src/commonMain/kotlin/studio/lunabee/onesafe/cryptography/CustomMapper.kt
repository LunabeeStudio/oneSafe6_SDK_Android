 ...
 *
 * Created by Lunabee Studio / Date - 9/2/2024 - for the oneSafe6 SDK.
...
fun ByteArray.toMessageSharingMode(): MessageSharingMode = MessageSharingMode.fromString(decodeToString())
...
// https://stackoverflow.com/a/67229929/10935947
fun Int.toByteArray(): ByteArray = ByteArray(4).apply {
...
fun Long.toByteArray(): ByteArray = ByteArray(8).apply {
    this[0] = (this@toByteArray shr 0).toByte()
    this[1] = (this@toByteArray shr 8).toByte()
    this[2] = (this@toByteArray shr 16).toByte()
    this[3] = (this@toByteArray shr 24).toByte()
...
fun Boolean.toByteArray(): ByteArray = if (this) byteArrayOf(1) else byteArrayOf(0)
